            ...
            return (
                <>
                    <div className={`${styles.wallet_top_wrapper} ${styles.ws_flex}`}>
                        <div className={styles.wallet_available_balance}>
                            ...
                            <div className={styles.available_balance_card}>
                                <div className={`${styles.available_balance_card_shapes} ${styles.justify_space_between} ${styles.ws_flex}`}>
                                    <img src={available_balance_circle}></img>
                                    <img src={available_balance_right_icon}></img>
                                </div>
                                <div>
                                    <h5>Account Balance</h5>
                                    <h3>205,700 <span>USD</span></h3></div>
                                <div className={`${styles.available_balance_card_footer} ${styles.ws_flex}`}>
                                    <div>
                                        <h6>Holder</h6>
                        ...
                        <div className={styles.wallet_available_balance}>
                            ...
                            <div className={styles.paymentMethodcard_section}>
                                {/* Card 1 */}
                                <label className={`${styles.card} ${selectedCard === 1 ? styles.selected : ''}`}>
                                    <input
                                        type="radio"
                                        name="paymentMethod"
                                        value="paypal"
                                    ...
                                    <div className={styles.card_content}>
                                        <img src={paypal_icon} alt="Paypal Icon" className={styles.card_image} />
                                        <div>
                                            <h4>Paypal</h4>
                                ...
                                {/* Card 2 */}
                                <label className={`${styles.card} ${selectedCard === 2 ? styles.selected : ''}`}>
                                    <input
                                        type="radio"
                                        name="paymentMethod"
                                        value="paypal2"
                                    ...
                                    />
                                    <div className={styles.card_content}>
                                        <img src={bank_transfer_icon} alt="Paypal Icon" className={styles.card_image} />
                                        <div>
                                            <h4>Bank Transfer</h4>
                                            <p>Connect your Bank Account</p></div>
                    ...
                    <div className={styles.payment_status_wrapper}>
                        <div className={`${styles.paymentStatus_title_wrapper} ${styles.ws_flex} ${styles.ai_center} ${styles.gap_10}`}>
                            <img src={mediaSetupIcon} alt="Media Setup Icon" />
